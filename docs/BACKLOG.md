...
**Boot scripts** (dans `index.html`, avant `app.js`) : `auth-cloud.js` → `cloud-hunts.js` → `core-ui.js`.

**Reste dans `app.js`** (prochaine cible P9) : routing (`switchPage`, `__PAGE_HTML`), helpers catalogue URL, templates hunt, init boot.
